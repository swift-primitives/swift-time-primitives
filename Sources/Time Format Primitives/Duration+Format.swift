...
extension Time.Format {
    ...
    /// - Returns: A format that displays the given number of decimal places.
    @inlinable
...
extension Time.Format: Formatter.`Protocol` {
    /// The input type this format consumes.
    public typealias Input = Swift.Duration

    /// The output type this format produces.
    public typealias Output = String

    /// The failure type; formatting a duration never throws.
