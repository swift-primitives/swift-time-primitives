...
extension Time.Month {
    /// Returns whether the first month is less than the second.
...
extension Time.Month {
    /// Compares a month with an integer value for equality.
    public static func == (lhs: Time.Month, rhs: Int) -> Bool {
        lhs.rawValue == rhs
    }

    /// Compares an integer value with a month for equality.
