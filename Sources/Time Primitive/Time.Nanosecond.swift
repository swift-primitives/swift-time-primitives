...
extension Time {
    ...
    public struct Nanosecond: Sendable, Equatable, Hashable, Comparable {
        ...
        /// Creates a nanosecond with validation.
        ///
...
extension Time.Nanosecond {
    /// Creates a nanosecond without validation (internal use only).
    ///
...
extension Time.Nanosecond {
    /// Returns whether the first nanosecond is less than the second.
