...
extension Time {
    ...
    public struct Microsecond: Sendable, Equatable, Hashable, Comparable {
        ...
        /// Creates a microsecond with validation.
        ///
...
extension Time.Microsecond {
    /// Creates a microsecond without validation (internal use only).
    ///
...
extension Time.Microsecond {
    /// Returns whether the first microsecond is less than the second.
