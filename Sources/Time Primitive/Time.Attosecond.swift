...
extension Time {
    ...
    public struct Attosecond: Sendable, Equatable, Hashable, Comparable {
        ...
        /// Creates an attosecond with validation.
        ///
...
extension Time.Attosecond {
    /// Creates an attosecond without validation (internal use only).
    ///
...
extension Time.Attosecond {
    /// Returns whether the first attosecond is less than the second.
