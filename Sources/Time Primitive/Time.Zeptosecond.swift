...
extension Time {
    ...
    public struct Zeptosecond: Sendable, Equatable, Hashable, Comparable {
        ...
        /// Creates a zeptosecond with validation.
        ///
...
extension Time.Zeptosecond {
    /// Creates a zeptosecond without validation (internal use only).
    ///
...
extension Time.Zeptosecond {
    /// Returns whether the first zeptosecond is less than the second.
