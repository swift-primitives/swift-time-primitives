...
extension Time.Month.Day {
    /// Returns whether the first day is less than the second.
...
extension Time.Month.Day {
    /// Compares a day with an integer value for equality.
    public static func == (lhs: Time.Month.Day, rhs: Int) -> Bool {
        lhs.rawValue == rhs
    }

    /// Compares an integer value with a day for equality.
