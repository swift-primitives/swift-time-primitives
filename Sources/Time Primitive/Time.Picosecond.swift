...
extension Time {
    ...
    public struct Picosecond: Sendable, Equatable, Hashable, Comparable {
        ...
        /// Creates a picosecond with validation.
        ///
...
extension Time.Picosecond {
    /// Creates a picosecond without validation (internal use only).
    ///
...
extension Time.Picosecond {
    /// Returns whether the first picosecond is less than the second.
