...
extension Time {
    ...
    public struct Yoctosecond: Sendable, Equatable, Hashable, Comparable {
        ...
        /// Creates a yoctosecond with validation.
        ///
...
extension Time.Yoctosecond {
    /// Creates a yoctosecond without validation (internal use only).
    ///
...
extension Time.Yoctosecond {
    /// Returns whether the first yoctosecond is less than the second.
