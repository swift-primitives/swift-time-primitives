...
extension Time {
    ...
    public struct Femtosecond: Sendable, Equatable, Hashable, Comparable {
        ...
        /// Creates a femtosecond with validation.
        ///
...
extension Time.Femtosecond {
    /// Creates a femtosecond without validation (internal use only).
    ///
...
extension Time.Femtosecond {
    /// Returns whether the first femtosecond is less than the second.
